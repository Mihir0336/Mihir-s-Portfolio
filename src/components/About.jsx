      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} style={{ y: line2Y }} className="ml-4">
            <span className="text-indigo-400">name</span>: <span className="text-gray-300">"Mihir Patel"</span>,
          </motion.div>
          
          <motion.div variants={itemVariants} style={{ y: line3Y }} className="ml-4">
            <span className="text-indigo-400">role</span>: <span className="text-gray-300">"Full Stack Developer"</span>,
          </motion.div>
