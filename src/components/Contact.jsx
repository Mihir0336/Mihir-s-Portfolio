          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:your.email@example.com" className="text-indigo-400 hover:underline">mihirpatel0336@gmail.com</a>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="flex space-x-4">
                {/* GitHub */}
                <motion.a 
                  href="https://github.com/mihir0336" target="_blank" 
                ...
                {/* LinkedIn */}
                <motion.a 
                  href="https://www.linkedin.com/in/mihir-patel-002443244" target="_blank"
                  className="bg-indigo-400/20 p-3 rounded-full transition-colors duration-300"
                  whileHover={{ scale: 1.1, backgroundColor: "rgba(129, 140, 248, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
                >
                ...
                {/* Instagram */}
                <motion.a 
                  href="https://instagram.com/mihir._.1432" target="_blank"
                  className="bg-indigo-400/20 p-3 rounded-full transition-colors duration-300"
                  whileHover={{ scale: 1.1, backgroundColor: "rgba(129, 140, 248, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
                >
